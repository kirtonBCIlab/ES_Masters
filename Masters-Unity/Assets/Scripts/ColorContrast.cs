...
namespace BCIEssentials.Utilities
{
    public class ColorContrast : MonoBehaviour 
    {
        ...
        {
            //R/G/B = 255
            Color _maximum = new Color(1f, 1f, 1f, 1f);

            //R/G/B = 145
            Color step1 = new Color(0.56862745f, 0.56862745f, 0.56862745f, 1f);

            //R/G/B = 82
            Color step2 = new Color(0.32156863f, 0.32156863f, 0.32156863f, 1f);

            //R/G/B = 47
            Color _minimum = new Color(0.18431373f, 0.18431373f, 0.18431373f, 1f);

            Color _off = new Color(0.00392157f, 0.00392157f, 0.00392157f,0);
